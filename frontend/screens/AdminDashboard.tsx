...
export const AdminDashboard: React.FC = () => {
  ...
  const [rooms, setRooms] = useState<Room[]>([
    ...
    },
    {
      ...
      status: 'Available',
      capacity: 30,
      image: 'https://images.unsplash.com/photo-1497366216548-37526070297c?ixlib=rb-1.2.1&auto=format&fit=crop&w=100&q=80'
    }
  ]);
                 ...
                 <div className="space-y-4">
                    <div className="flex items-start justify-between p-3 border border-gray-100 rounded-lg">
                       <div className="flex gap-3">
                          <div className="w-10 h-10 rounded-full bg-gray-100 flex items-center justify-center font-bold text-xs">SC</div>
                          <div>
                             <p className="text-sm font-medium">Sarah Chen (Student)</p>
                             <p className="text-xs text-gray-500">Requested: Lab-101</p>
                          </div>
                       </div>
                       <button className="text-xs bg-brand text-white px-3 py-1 rounded">Review</button>
                    </div>
                 </div>
              </div>
            </div>
